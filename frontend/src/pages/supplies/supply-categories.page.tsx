...
export function SupplyCategoriesPage() {
  ...
  const createMut = useMutation({
    mutationFn: () => suppliesApi.createCategory(nombre, descripcion || undefined),
    onSuccess: () => {
  ...
  const deleteMut = useMutation({
    mutationFn: (id: string) => suppliesApi.removeCategory(id),
    onSuccess: () => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold">Categorías de Suministros</h1>
        ...
        <DialogContent>
          ...
          <div className="space-y-4">
            ...
            <Button
              ...
              onClick={() => {
                if (editing) {
                  suppliesApi.updateCategory(editing.id, { nombre, descripcion: descripcion || undefined }).then(() => {
